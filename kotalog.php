<!DOCTYPE html>
<html lang="ru">
<link rel="stylesheet" href="css/kotalog.css">
                        ...
                        <div>
                            <ul>
                                <li><strong>Вконтакте</strong></li>
                                    <p>1. Помощник для студента (гибридный Чат-бот для всех соц. сетей).</p>
                                <li><strong>Телеграм</strong></li>
                                    <p>1. Помощник для студента (гибридный Чат-бот для всех соц. сетей).<br>2. Косметический бот</p>
                            </ul>
                        </div>
                        <h2>Сайты</h2>
                        <div>
                            <ul>
                                <li><strong>Эдельвейс</strong></li>
                                    <p>1. Сайт для выполнения лабораторной работы номер 1.</p>
                            </ul>
                        </div>
                        <h2>Конструкторы</h2>
                        <div>
                            <ul>
                                <li><strong>Compucter</strong></li>
                                    <p>Пока не разработан</p>
                            </ul>
                        </div>
                    </div>
                </section>
